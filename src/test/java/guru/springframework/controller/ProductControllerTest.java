...
public class ProductControllerTest {
    ...
    public void testShow() throws Exception {
        ...
        mockMvc.perform(get("/v1/product/get/1"))
                .andExpect(status().isOk())
    ...
    public void testEdit() throws Exception {
        ...
        //Tell Mockito stub to return new product for ID 1
        when(productService.getById(id)).thenReturn(new Product());
        mockMvc.perform(get("/v1/product/update/1"))
                .andExpect(status().isOk())
    ...
    public void testNewProduct() throws Exception {
        ...
        mockMvc.perform(get("/v1/product/new"))
                .andExpect(status().isOk())
                .andExpect(view().name("productform"))
                .andExpect(model().attribute("product", instanceOf(Product.class)));
    }
    ...
    public void testSaveOrUpdate() throws Exception {
        ...
        mockMvc.perform(post("/v1/product")
                ...
                .andExpect(view().name("redirect:/v1/product/1"))
                .andExpect(model().attribute("product", instanceOf(Product.class)))
                .andExpect(model().attribute("product", hasProperty("id", is(id))))
                .andExpect(
                        model().attribute("product", hasProperty("description", is(description))))
    ...
    public void testDelete() throws Exception {
        Integer id = 1;
        mockMvc.perform(post("/v1/product/delete")
                .param("id", String.valueOf(id))
        )
                .andExpect(status().is3xxRedirection())
                .andExpect(view().name("redirect:/v1/products"));
